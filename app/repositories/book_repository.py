...
class BookRepository:
    ...
    def get_book_by_id(book_id):
        return Book.query.get_or_404(book_id) # Better error handling
    ...
    @staticmethod
    def add_new_book(book_name, book_image, author, publisher, book_genre, edition, isbn, price, lib_id, book_stock, volume=None):
        try:
            with db.session.begin():
                ...
                copies = [Copies(book_id=new_book.book_id, loc_id=1) for _ in range(book_stock)] # Added required loc_id
...
class BorrowRepository:
    ...
    def get_borrowing_by_id(borrow_id):
        return Borrowing.query.get_or_404(borrow_id)  # Better error handling
    ...
    @staticmethod
    def get_borrowings_by_return_date(return_date):  # Fixed parameter name
...
class ReserveRepository:
    ...
    def get_reservation_by_id(reserve_id):
        return Reserve.query.get_or_404(reserve_id)  # Better error handling
